...
const logos = [
  ...
  { src: "/assets/languages/FastAPI.png", alt: "FastAPI", label: "FastAPI" },
  ...
  { src: "/assets/languages/PostgreSQL.png", alt: "PostgreSQL", label: "PostgreSQL" },
  { src: "/assets/languages/Python.png", alt: "Python", label: "Python" },
  { src: "/assets/languages/React.png", alt: "React", label: "React" },
  { src: "/assets/languages/Shadcn.png", alt: "Shadcn UI", label: "Shadcn UI" },
  { src: "/assets/languages/SQL.png", alt: "SQL", label: "SQL" },
  { src: "/assets/languages/Supabase.png", alt: "Supabase", label: "Supabase" },
  { src: "/assets/languages/Tailwind.png", alt: "Tailwind", label: "Tailwind" },
  { src: "/assets/languages/Typescript.png", alt: "TypeScript", label: "TypeScript" },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {logos.map((logo, index) => (
              <AnimatedSection key={logo.src} delay={index * 50}>
                <div className="flex items-center gap-5 bg-subtle rounded-2xl px-6 py-5 h-24">
                  ...
                  <span className="text-text-secondary text-base font-medium">{logo.label}</span>
                </div>
              </AnimatedSection>
            ))}
          </div>
